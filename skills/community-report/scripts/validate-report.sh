#!/usr/bin/env bash
#
# validate-report.sh - Validate community report format and completeness
#
# Usage:
...
usage() {
    ...
    echo ""
    echo "Validates a community report for completeness and format."
    echo ""
    echo "Example:"
    echo "  $(basename "$0") docs/reports/2026-02-community-report.md"
}
